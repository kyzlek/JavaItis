...
public class DaoFactory {
    ...
    private DaoFactory() {
        ...
        try {
            properties.load(new FileInputStream("C:\\Users\\Kyzlek_pc\\Desktop\\JavaItis\\JdbcDaoSceletonJSP\\src\\main\\resources\\dao.properties"));

            String daoClassName = properties.getProperty("dao.class");
            //ru.itis.dao.OwnersDaoJdbcImpl
